...
#ifndef APPBOXCORESDK_SWIFT_H
#define APPBOXCORESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppBoxCoreSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC13AppBoxCoreSDK23CoreAppPushInfoApiModel")
@interface CoreAppPushInfoApiModel : NSObject
...
SWIFT_CLASS("_TtC13AppBoxCoreSDK16CoreFirebaseInfo")
@interface CoreFirebaseInfo : NSObject
