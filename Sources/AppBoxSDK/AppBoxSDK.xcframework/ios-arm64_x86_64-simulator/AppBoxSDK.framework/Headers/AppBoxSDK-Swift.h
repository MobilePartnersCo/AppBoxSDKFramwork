...
/// <h1>APNs 토큰 등록</h1>
/// APNs에서 발급받은 디바이스 토큰을 Firebase에 등록합니다.
/// <h2>Parameters</h2>
/// <ul>
///   <li>
///     <code>apnsToken</code>: APNs 디바이스 토큰
///   </li>
/// </ul>
/// <h2>Author</h2>
/// <ul>
...
///     AppBox.shared.appBoxPushApnsToken(apnsToken: deviceToken)
/// }
///
/// \endcode<h2>Note</h2>
/// <ul>
///   <li>
///     이 메서드는 <code>AppDelegate.swift</code>의 <code>didRegisterForRemoteNotificationsWithDeviceToken</code>에서 호출해야 합니다
///   </li>
/// </ul>
- (void)appBoxPushApnsTokenWithApnsToken:(NSData * _Nonnull)apnsToken;
/// <h1>Push 토큰 전송</h1>
/// Push 알림 수신 동의 여부와 함께 토큰을 서버에 전송합니다.
/// <h2>Parameters</h2>
/// <ul>
///   <li>
///     <code>pushYn</code>: 푸시 알림 수신 동의 여부 (“Y” 또는 “N”)
///   </li>
///   <li>
///     <code>completion</code>: 완료 콜백
///     <ul>
///       <li>
///         <code>Bool</code>: 권한 요청 성공 여부
///       </li>
///       <li>
///         <code>Bool</code>: API 호출 성공 여부
///       </li>
///     </ul>
///   </li>
/// </ul>
...
/// <h2>Example</h2>
/// \code
/// AppBox.shared.appBoxPushSendToken(pushYn: "Y") { permissionSuccess, apiSuccess in
///     if permissionSuccess && apiSuccess {
///         print("Push 토큰 등록 성공")
///     }
/// }
///
/// \endcode
- (void)appBoxPushSendTokenWithPushYn:(NSString * _Nonnull)pushYn completion:(void (^ _Nonnull)(BOOL, BOOL))completion;
/// <h1>세그먼트 설정</h1>
/// 사용자 세그먼트 정보를 서버에 전송합니다.
/// <h2>Parameters</h2>
/// <ul>
///   <li>
///     <code>segment</code>: 세그먼트 정보 딕셔너리
///   </li>
///   <li>
///     <code>completion</code>: 완료 콜백 (성공 여부)
///   </li>
/// </ul>
/// <h2>Author</h2>
/// <ul>
...
/// <h2>Example</h2>
/// \code
/// let segment = ["age": "20", "gender": "M"]
/// AppBox.shared.appBoxSetSegment(segment: segment) { success in
///     print("세그먼트 설정: \(success)")
/// }
///
/// \endcode
- (void)appBoxSetSegmentWithSegment:(NSDictionary<NSString *, NSString *> * _Nonnull)segment completion:(void (^ _Nonnull)(BOOL))completion;
/// <h1>AppBoxPushSDK</h1>
